...
@Component({
  selector: 'app-reactive-form-user',
  imports: [ReactiveFormsModule, FooterComponent, NgIf],
  templateUrl: './reactive-form-user.component.html',
  styleUrl: './reactive-form-user.component.css',
})
export class ReactiveFormUserComponent {
